...
link: "https://www.trip.com/restaurant/china/chengdu/detail/obibi-31252057/"
...
rozwijalne_listy:
  - tytul: "Rezerwacja"
    tresc: |
      <ul>
        ...
        Rezerwacja online bywa przydatna wyłącznie przy mocno limitowanych edycjach specjalnych desery (np. Tiramisu Milk Tea). Na miejscu wystarczy ustawić się w tradycyjnej kolejce.
        </li>
      </ul>
  ...
  - tytul: "Dojazd"
    tresc: |
      <ul>
        <li><b>Z centrum Chengdu (Kuanzhai Alley / Tianfu Square)</b><br>
         Wsiądź w Linię 4 metra w Chengdu i wysiądź na stacji Kuanzhai Alley Station (Exit B). 
         <br> Stamtąd przejdź krótki, 8-minutowy spacer w stronę klimatycznej, kulinarnej uliczki Kui Xing Lou Street (奎星楼街). Lokalu szukaj pod numerem 16.
        </li><br>
  ...
  - tytul: "Przydatne informacje"
    tresc: |
      <ul>
        <li><b>Dostosuj poziom słodkości:</b><br>
        Podobnie jak w większości chińskich kawiarni bubble tea, przy zamówieniu możesz określić poziom cukru (sugar level) oraz ilość lodu (ice level). Jeśli wolne wolisz mniej słodkie napoje, wybierz 30% lub 50% cukru.
        </li><br>

        <li><b>Lokalny hak:</b><br>
       Po wypiciu herbaty przejdź się całą ulicą Kui Xing Lou – to jedno z najbardziej znanych skupisk ulicznego jedzenia w Chengdu, idealne na spróbowanie syczuańskich szaszłyków chuan chuan.
        </li><br>
...
galeria_zdjec:
  ...
  - url: "https://ak-d.tripcdn.com/images/01A1u12000a2s6p4j20CE.jpg"
...
### Kawiarnia Obibi
Wstępując do kawiarni Obibi na kultowej ulicy Kui Xing Lou w Chengdu, natychmiast trafiasz do najsłodszego zakątka stolicy prowincji Syczuan. Chengdu to światowa stolica wielkich pand, a Obibi mistrzowsko przenosi tę miłość na kulinarną mapę miasta. Lokalne herbaty z mlekiem, kremowe pianki i kawy zamieniają się tu w małe dzieła sztuki – od puszystych pianek w kształcie uszu i pyszczków pand, po posypki z węgla bambusowego w formie śladów łapek. To miejsce pachnie świeżo parzoną chińską herbatą, palonym cukrem i słodkim tiramisu, oferując estetykę, obok której żaden miłośnik trendów i podróży nie przejdzie obojętnie.
<!-- Sekcja rozwijalna (details/summary w czystym HTML) -->

### Fakty i Ciekawostki

* **Piankowa rzeźba w filiżance:** Flagowy napój Obibi Panda Milk Tea wykańczany jest ręcznie formowaną, sztywną pianką mleczną przedstawiającą trójwymiarową pandę, która delikatnie unosi się na powierzchni napoju.
