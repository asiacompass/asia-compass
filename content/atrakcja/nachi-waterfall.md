...
rozwijalne_listy:
  - tytul: "Rezerwacja"
    tresc: |
      <ul>
        <li><b>Rezerwacja:</b><p>
         Brak konieczności rezerwacji: Taras widokowy oraz otoczenie wodospadu są dostępne bez wcześniejszej rezerwacji online. Brak limitów wejść.
        </li>
      </ul>
  ...
  - tytul: "Wejście i ceny"
    tresc: |
      ...
      <ul>
       <li><b>Ceny:</b><p>
         Podziwianie wodospadu z głównego punktu widokowego oraz terenu wokół jest darmowe. Jeśli chcesz podejść bliżej samej kaskady na specjalny podwyższony taras widokowy (Hiro-jinja Takimai-ba), bilet wstępu kosztuje 300 JPY (w cenie dostajesz mały drewniany kubeczek do spróbowania świętej wody).
       </li>
        
       <li><b>Godziny:</b><p>
         Teren wokół wodospadu jest otwarty przez całą dobę. Bliższy taras widokowy i punkt sprzedaży amuletów otwarte są w godzinach 07:00 – 16:30.
       </li>

       <li> Najlepsza pora na wizytę: Wczesny poranek (ok. 08:00–09:00), gdy światło słoneczne przebija się przez mgłę, a wokół nie ma jeszcze autokarów wycieczkowych.
       </li>
      </ul>
  ...
  - tytul: "Dojazd"
    tresc: |
      ...
      Nachi Waterfall znajduje się w rejonie Nachikatsuura na półwyspie Kii (prefektura Wakayama)
  ...
  - tytul: "Przydatne wskazówki"
    tresc: |
     <ul>
      <li><b>Wygodne buty to podstawa:</b><br>
         Zwiedzanie całego kompleksu (wodospad, pagoda Seiganto-ji i świątynia Kumano Nachi Taisha) wiąże się z pokonaniem setek kamiennych, stromych schodów.
      </li><br>

      <li><b>Kultowy kadrowo punkt:</b><br>
         Słynne zdjęcie 3-piętrowej czerwonej pagody z wodospadem w tle zrobisz ze specjalnego punktu widokowego przy świątyni Seiganto-ji (ok. 10–15 minut spacerem pod górę od wodospadu). 
      </li><br>

      <li><b>Daimon-zaka:</b><br>
         Jeśli masz czas i siłę, wysiądź przystanek wcześniej na Daimon-zaka i przejdź urokliwym, 600-metrowym odcinkiem szlaku Kumano Kodo otoczonym kilkusetletnimi cedrami.
      </li>
...
galeria_zdjec:
  ...
  - url: "https://images.pexels.com/photos/32558530/pexels-photo-32558530.jpeg"
  - url: "https://images.pexels.com/photos/30978497/pexels-photo-30978497.jpeg"



instagram_reel: "https://www.instagram.com/reel/Da5fP49oZUo/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=="
...
* **Wodospad jako żywe bóstwo (Kami):** W tradycji Shinto wodospad Nachi nie jest jedynie cudem natury, ale żywym wcieleniem bóstwa Ōnamuchi no Mikoto. Sama kaskada jest czczona jako główny obiekt kultu pobliskiego sanktuarium Hiro-jinja (części kompleksu Kumano Nachi Taisha).

* **Święta woda dająca długowieczność:** Woda spływająca z wodospadu od wieków uważana jest za świętą. Według legendy krople rozpryskujące się u jego podstawy przynoszą zdrowie, pomyślność i długie życie.
